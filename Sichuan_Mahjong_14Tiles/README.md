# Sichuan Mahjong 14-Tiles Solver

This project is an automated solver for the 14-tile variant of Sichuan Mahjong (also known as Blood River/Battle Mahjong, where one suit must be voided). It takes a screenshot of your starting hand, automatically detects the tiles using computer vision, and calculates the optimal strategy for playing the hand using various search algorithms.

## Features

- **Automatic Hand Recognition:** Uses OpenCV template matching to identify your 14 tiles from a screenshot.
...
2. Place a screenshot of your 14-tile Mahjong hand into the `screenshots/` directory. (Ensure the screenshot matches the expected dimensions and alignment for the templates).
